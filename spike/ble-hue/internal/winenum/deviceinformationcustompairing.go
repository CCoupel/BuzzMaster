...
func (impl *DeviceInformationCustomPairing) PairWithProtectionLevelAndSettingsAsync(pairingKindsSupported DevicePairingKinds, minProtectionLevel DevicePairingProtectionLevel, devicePairingSettings *IDevicePairingSettings) (*foundation.IAsyncOperation, error) {
	itf := impl.MustQueryInterface(ole.NewGUID(GUIDiDeviceInformationCustomPairing))
	defer itf.Release()
	v := (*iDeviceInformationCustomPairing)(unsafe.Pointer(itf))
	return v.PairWithProtectionLevelAndSettingsAsync(pairingKindsSupported, minProtectionLevel, devicePairingSettings)
}
...
func (v *iDeviceInformationCustomPairing) PairWithProtectionLevelAndSettingsAsync(pairingKindsSupported DevicePairingKinds, minProtectionLevel DevicePairingProtectionLevel, devicePairingSettings *IDevicePairingSettings) (*foundation.IAsyncOperation, error) {
	var out *foundation.IAsyncOperation
	hr, _, _ := syscall.SyscallN(
		v.VTable().PairWithProtectionLevelAndSettingsAsync,
		uintptr(unsafe.Pointer(v)),                     // this
		uintptr(pairingKindsSupported),                 // in DevicePairingKinds
		uintptr(minProtectionLevel),                    // in DevicePairingProtectionLevel
		uintptr(unsafe.Pointer(devicePairingSettings)), // in IDevicePairingSettings
		uintptr(unsafe.Pointer(&out)),                  // out foundation.IAsyncOperation
	)
