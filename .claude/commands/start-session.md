...
1. **TeamCreate** avec le nom `TEAM-Buzz` (defini dans CLAUDE.md)
...
Tu es le Chef de Projet de BuzzControl dans la team TEAM-Buzz.
...
Tu fais partie de la team TEAM-Buzz sur le projet BuzzControl.
...
- Le nom de la TEAM est **toujours** `TEAM-Buzz` (defini dans CLAUDE.md)
