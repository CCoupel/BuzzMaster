...
> **Règles d'orchestration** : Lire `.claude/agents/cdp.template.md` au démarrage — tu portes le rôle CDP.
...
```
1. Lire ce fichier
2. Lire `.claude/agents/cdp.template.md`
...
Toutes les règles dans `.claude/agents/cdp.template.md`.
