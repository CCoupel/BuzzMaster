...
| `SOUND` | string | ❌ | Chemin du fichier WAV audio attaché à la question | v11.1.0 (#219) |
| `SOUND_TIMER_DELAYED` | boolean | ❌ | Si `true`, le chronomètre démarre à la fin du son ; si `false`, simultanément avec le son | v11.1.0 (#219) |
